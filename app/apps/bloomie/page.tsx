        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            <a
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 bg-black text-white font-semibold rounded-2xl shadow-lg hover:bg-gray-800 transition-all duration-200 text-lg"
            >
              {/* Apple logo SVG */}
