          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-8">
            <div className="flex flex-col justify-between items-center h-20 w-full max-w-xs">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-3 px-6 py-3 bg-black text-white font-semibold rounded-2xl shadow-lg hover:bg-gray-800 transition-all duration-200 text-base w-full"
              >
