      ...
      <section className="relative py-16 px-4 min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-pink-100 via-purple-50 to-rose-50 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="#"
              className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#"
              className="w-full sm:w-auto bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex justify-center">
              <div className="bg-white rounded-3xl shadow-xl p-4 transform hover:scale-105 transition-transform duration-300">
                <Image
                  src="/screenshot/ss2.jpg"
                  alt="Cantik App Screenshot 2"
                  width={300}
                  height={600}
                  className="rounded-2xl"
                />
            ...
            <div className="flex justify-center">
              <div className="bg-white rounded-3xl shadow-xl p-4 transform hover:scale-105 transition-transform duration-300">
                <Image
                  src="/screenshot/ss3.jpg"
                  alt="Cantik App Screenshot 3"
                  width={300}
                  height={600}
                  className="rounded-2xl"
                />
