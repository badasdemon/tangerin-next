      ...
      <section className="relative py-16 px-4 min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-pink-100 via-purple-50 to-rose-50 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <div className="flex flex-col justify-between items-center h-20 w-full max-w-xs">
              <a
                href="#"
                className="flex-1 flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-base w-full"
              >
            ...
            <div className="flex flex-col justify-between items-center h-20 w-full max-w-xs">
              <a
                href="#"
                className="flex-1 flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-base w-full"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="h-6 flex items-end">
                <p className="text-base text-gray-600 font-medium mt-2">(coming soon)</p>
              </div>
            </div>
          </div>
        </div>
